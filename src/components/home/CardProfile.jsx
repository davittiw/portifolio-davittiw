...
function CardProfile () {
    ...
    return (
            <div className="min-h-screen w-full sm:w-90 md:w-120 lg:w-120 flex flex-col items-center justify-center">

                <div className='w-full sm:w-90 md:w-120 lg:w-120 p-3 sm:p-4 md:p-4 lg:p-4 flex flex-row text-white bg-[var(--black-gray)] rounded-xl items-center justify-center border border-gray-700 shadow-3xl'>
                    <img
                    ...
                    <div className='flex flex-col p-4 justify-center text-left w-full gap-1.5'>
                        <div className='flex flex-row justify-between items-center'>
                            <h1 className='font-bold'>Luccas | @davittiw</h1>
